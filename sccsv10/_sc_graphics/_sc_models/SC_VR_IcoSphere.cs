...
namespace _sc_core_systems.SC_Graphics.SC_Models
{
    public class SC_VR_IcoSphere //: ITransform, IComponent
    {
        ...
        */
        ...
        private bool InitializeBuffer(SharpDX.Direct3D11.Device device)
        {
            try
            {
                ...
                sphere.OnWizardCreate(1, 3,out verts,out trigs);
