...
namespace _sc_core_systems.SC_Graphics
{
    public class SC_visual_object_manager
    {
        ...
        //int 
        public void _create_human_rig(SC_console_directx D3D, IntPtr HWND, World World, Matrix WorldMatrix, float size_screen, float r, float g, float b, float a, int instX, int instY, int instZ, float offsetPosX, float offsetPosY, float offsetPosZ,float mass)
        {
            _humRig = new SC_human_RIG( D3D,  HWND,  World,  WorldMatrix,  size_screen,  r,  g,  b,  a,  instX,  instY,  instZ,  offsetPosX,  offsetPosY,  offsetPosZ,mass);
