    ...
    public class SC_Console_GRAPHICS
    {
        ...
        public bool Initialize(_sc_core_systems._sc_core._sc_system_configuration configuration, IntPtr windowsHandle, _sc_console._sc_console_writer _writer)
        {
            ...
            try
            {
                ...
                /*_screenDirMatrix = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                _screenDirMatrix_correct_pos = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                point3DCollection = new Vector3[world_instance_x * world_instance_y * world_instance_z][];
                _world_screen_list = new SC_cube[world_instance_x * world_instance_y * world_instance_z];
                _world_screen_assets_list = new SC_cube[world_instance_x * world_instance_y * world_instance_z];
                worldMatrix_instances_screens = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                world_last_Matrix_instances_screens = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_screen_assets = new Matrix[world_instance_x * world_instance_y * world_instance_z][];*/
