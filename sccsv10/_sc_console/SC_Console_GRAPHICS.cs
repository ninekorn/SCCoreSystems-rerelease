...
namespace _sc_core_systems
{
    ...
    {
        int startworkbuffers = 0;


        int swtchinstantsound = -1;


        //https://stackoverflow.com/questions/30422655/sorting-list-of-list-of-bytes-or-list-of-byte-arrays
        ...
        public const int world_instance_x = 1; //4
        public const int world_instance_y = 1; //1
        public const int world_instance_z = 1; //4
        ...
        int _inst_spectrum_x = 420; // 36 // 210 //75
        int _inst_spectrum_y = 1;
        int _inst_spectrum_z = 210; // 36 // 210 //75 //5625
        ...
        byte[] _sound_byte_array = new byte[88200]; //44100
        byte[] _sound_byte_array_instant = new byte[88200]; //44100 //176400
        ...
        public bool Initialize(_sc_core_systems._sc_core._sc_system_configuration configuration, IntPtr windowsHandle, _sc_console._sc_console_writer _writer)
        {
            ...
            try
            {
                ...
                _world_list = new World[world_instance_x * world_instance_y * world_instance_z];
                _world_cube_list = new SC_cube[world_instance_x * world_instance_y * world_instance_z];
                _world_terrain_tile_list = new SC_cube[world_instance_x * world_instance_y * world_instance_z];
                _world_voxel_cube_lists = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];

                worldMatrix_instances_cubes = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_voxel_cube = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_terrain_tiles = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                _array_of_colors = new Vector4[world_instance_x * world_instance_y * world_instance_z][];

                _objects_static_00 = new int[world_instance_x * world_instance_y * world_instance_z][];
                _objects_static_counter_00 = new int[world_instance_x * world_instance_y * world_instance_z][];
                _objects_rigid_static_00 = new RigidBody[world_instance_x * world_instance_y * world_instance_z][];
                _switch_for_collision = new int[world_instance_x * world_instance_y * world_instance_z][];
                ...
                //HUMAN RIG STUFF
                _player_rght_hnd = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_lft_upper_arm = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_lft_hnd = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_torso = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_pelvis = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_rght_shldr = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_lft_shldr = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_head = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_rght_lower_arm = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_lft_lower_arm = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_rght_upper_arm = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_rght_elbow_target = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_lft_elbow_target = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_rght_elbow_target_two = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];
                _player_lft_elbow_target_two = new _sc_voxel[world_instance_x * world_instance_y * world_instance_z];

                worldMatrix_instances_r_elbow_target = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_l_elbow_target = new Matrix[world_instance_x * world_instance_y * world_instance_z][];

                worldMatrix_instances_r_elbow_target_two = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_l_elbow_target_two = new Matrix[world_instance_x * world_instance_y * world_instance_z][];

                worldMatrix_instances_head = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_torso = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_pelvis = new Matrix[world_instance_x * world_instance_y * world_instance_z][];

                worldMatrix_instances_r_hand = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_l_hand = new Matrix[world_instance_x * world_instance_y * world_instance_z][];

                worldMatrix_instances_r_shoulder = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_l_shoulder = new Matrix[world_instance_x * world_instance_y * world_instance_z][];

                worldMatrix_instances_r_upperarm = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_l_upperarm = new Matrix[world_instance_x * world_instance_y * world_instance_z][];

                worldMatrix_instances_r_lowerarm = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_l_lowerarm = new Matrix[world_instance_x * world_instance_y * world_instance_z][];

                worldMatrix_instances_r_upperleg = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_l_upperleg = new Matrix[world_instance_x * world_instance_y * world_instance_z][];

                worldMatrix_instances_r_lowerleg = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_l_lowerleg = new Matrix[world_instance_x * world_instance_y * world_instance_z][];

                worldMatrix_instances_r_foot = new Matrix[world_instance_x * world_instance_y * world_instance_z][];
                worldMatrix_instances_l_foot = new Matrix[world_instance_x * world_instance_y * world_instance_z][];



                //RAYCAST STUFF
                _some_reset_for_applying_force = new int[world_instance_x * world_instance_y * world_instance_z][];
                _some_frame_counter_raycast_00 = new int[world_instance_x * world_instance_y * world_instance_z][];
                _some_frame_counter_raycast_01 = new int[world_instance_x * world_instance_y * world_instance_z][];
                _switch_for_collision = new int[world_instance_x * world_instance_y * world_instance_z][];
                _some_last_frame_vector = new JVector[world_instance_x * world_instance_y * world_instance_z][][];
                _some_last_frame_rigibodies = new RigidBody[world_instance_x * world_instance_y * world_instance_z][][];
                ...
                for (int x = 0; x < world_instance_x; x++)
                {
                    for (int y = 0; y < world_instance_y; y++)
                    {
                        for (int z = 0; z < world_instance_z; z++)
                        {
                            var _index = x + world_instance_x * (y + world_instance_y * z);
                ...
                _world_screen_list = new SC_cube[1];
                _world_screen_assets_list = new SC_cube[1];
                worldMatrix_instances_screens = new Matrix[1][];
                world_last_Matrix_instances_screens = new Matrix[1][];
                worldMatrix_instances_screen_assets = new Matrix[9][];
                ...
                {
                    worldMatrix_instances_spectrum[0][i] = _world_spectrum_list[0]._arrayOfInstances[i]._POSITION;
                }
                ...
                */
                ...
                //_offsetPos = new Vector3((world_instance_x * 1) * 0.375f, 0, world_instance_z * 1);
                //originPos = new SharpDX.Vector3(-3, 1, 3);

                //MessageBox((IntPtr)0, _hasinit0 + "", "Oculus error", 0);

                Vector3 lightPosition = new Vector3(0, 1, 0);
                Vector4 ambientColor = new Vector4(0.65f, 0.65f, 0.65f, 1.0f);
                Vector4 diffuseColour = new Vector4(1, 1, 1, 1);

                Vector3 direction_feet_forward = new Vector3(0,0,1);
                ...
                //FOR CIRCLE SPECTRUM        
                //unify wiki for unity3d i think but not sure or unity3d forums or gamedev stackexchange. 
                float xc;
                float yc;
                ...
                for (int i = 0; i < n; i++)
                {
                    xc = (float)(radius * Math.Sin((2 * Math.PI * i) / n));
                    yc = (float)(radius * Math.Cos((2 * Math.PI * i) / n));

                    vertexList.Add(new Vector3(xc, yc, 0f));
                }
                circlevertex = vertexList.ToArray();
        ...
        {
            var _indexer = 0;// x + world_instance_x * (y + world_instance_y * z);
            ...
            var oculusRiftDir = sc_maths._getDirection(Vector3.ForwardRH, quatter);

            Matrix hmd_matrix_current;
                ...
                for (int x = -widthL; x <= widthR; x++)
                {
                    for (int y = -heightL; y <= heightR; y++)
                    {
                        for (int z = -depthL; z <= depthR; z++)
                        {
                            ...
                            try
                            {                               
                                if (_index < _world_spectrum_list[0]._arrayOfInstances.Length && _index < _sound_byte_array.Length) //_inst_spectrum_x * _inst_spectrum_y * _inst_spectrum_z)
                                {
                                    if (_sound_byte_array != null)
                                    {
                                        if (_sound_byte_array.Length > 0)
                                        {
                                            ...
                                            spectrum_mat.M41 = _left_touch_pos.X + _world_spectrum_list[0]._arrayOfInstances[_index]._POSITION.M41;
                                            spectrum_mat.M42 = _left_touch_pos.Y + _world_spectrum_list[0]._arrayOfInstances[_index]._POSITION.M42 + spectrum_noise_value + (_sound_byte_array[_index] * 0.0005f); //0.0015f
                                            spectrum_mat.M43 = _left_touch_pos.Z + _world_spectrum_list[0]._arrayOfInstances[_index]._POSITION.M43;
            ...
            try
            {
                    ...
                    if (_can_work_physics == 1)
                    {
                        ...
                        for (int x = 0; x < world_instance_x; x++)
                        {
                            for (int y = 0; y < world_instance_y; y++)
                            {
                                for (int z = 0; z < world_instance_z; z++)
                                {
                                    if (_world_list[x + world_instance_x * (y + world_instance_y * z)] != null)
                                    {
                                        ...
                                        _world_list[x + world_instance_x * (y + world_instance_y * z)].Step(deltaTime, true);
                                    }
                                }
                            }
                        }
                ...
                if (_start_background_worker_01 == 0)
                {
                    if (_can_work_physics == 1)
                    {
                        ...
                        //LIGHTS
                        //LIGHTS
                        var threaders = new BackgroundWorker();
                        threaders.DoWork += (object sender, DoWorkEventArgs argers) =>
                        {
                        //object[] parametors = args.Argument as object[];
                        //var workor = (_task_worker)parametors[0];
                        ...
                        _thread_looper:
                            ...
                            float disco_sphere_rot_speed = 1.15f;
                            ...
                            Matrix tempmat = world;// _player_rght_hnd[0]._arrayOfInstances[0].current_pos; //_player_rght_hnd[0]._arrayOfInstances[0].current_pos
                            ...
                            var lightDirection = direction_feet_forward; // new Vector3(_player_rght_hnd[0]._arrayOfInstances[0].current_pos.M41, _player_rght_hnd[0]._arrayOfInstances[0].current_pos.M42, _player_rght_hnd[0]._arrayOfInstances[0].current_pos.M43);

                            _DLightBuffer[0].lightDirection = lightDirection;
                            _DLightBuffer[0].lightPosition = lightPosition;

                            _DLightBuffer_voxel_cube[0].lightDirection = lightDirection;
                            _DLightBuffer_voxel_cube[0].lightPosition = lightPosition;

                            _DLightBuffer_spectrum[0].lightDirection = lightDirection;
                            _DLightBuffer_spectrum[0].lightPosition = lightPosition;

                            _SC_modL_torso_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_torso_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_rght_hnd_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_rght_hnd_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_lft_hnd_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_lft_hnd_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_rght_shldr_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_rght_shldr_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_lft_shldr_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_lft_shldr_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_rght_elbow_target_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_rght_elbow_target_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_rght_elbow_target_two_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_rght_elbow_target_two_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_rght_upper_arm_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_rght_upper_arm_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_rght_lower_arm_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_rght_lower_arm_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_lft_elbow_target_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_lft_elbow_target_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_lft_elbow_target_two_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_lft_elbow_target_two_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_lft_upper_arm_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_lft_upper_arm_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_lft_lower_arm_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_lft_lower_arm_BUFFER[0].lightPosition = lightPosition;

                            _SC_modL_pelvis_BUFFER[0].lightDirection = lightDirection;
                            _SC_modL_pelvis_BUFFER[0].lightPosition = lightPosition;
                ...
                */
                        ...
                        for (int y = 0; y < world_instance_y; y++)
                        {
                            for (int z = 0; z < world_instance_z; z++)
                            {
                                ...
                                for (int _iterator = 0; _iterator < _player_rght_hnd[_index]._arrayOfInstances.Length; _iterator++) //
                                {
                                    ...
                                    //realPIVOTOfUpperArm.X = _player_rght_shldr[_index]._arrayOfInstances[_iterator].current_pos.M41;
                                    //realPIVOTOfUpperArm.Y = _player_rght_shldr[_index]._arrayOfInstances[_iterator].current_pos.M42;
                                    //realPIVOTOfUpperArm.Z = _player_rght_shldr[_index]._arrayOfInstances[_iterator].current_pos.M43;
                                    ...
                                    lengthOfLowerArmRight = _player_rght_lower_arm[_index]._total_torso_height * 2.45f;
                                    lengthOfUpperArmRight = _player_rght_upper_arm[_index]._total_torso_height * 2.55f;
                                    ...
                                    var resultor = Math.Pow(lengthOfUpperArmRight, 2) - Math.Pow(adjacentSolvingForX, 2);
                                    if (resultor < 0)
                                    {
                                        resultor *= -1;
                                    }
                                    //resultor = Math.Min(resultor, lengthOfUpperArmRight - lengthOfUpperArmRight * 0.001f);

                                    var oppositeSolvingForHalfA = (float)Math.Sqrt(resultor);
                                    ...
                                    var someCrossLArm00 = _player_rght_upper_arm[_index]._arrayOfInstances[_iterator]._ELBOWCROSSVEC;
                                    ...
                                    resultor = Math.Pow(lengthOfUpperArmRight, 2) - Math.Pow(adjacentSolvingForX, 2);
                                    if (resultor < 0)
                                    {
                                        resultor *= -1;
                                    }

                                    oppositeSolvingForHalfA = (float)Math.Sqrt(resultor);
                                ...
                                /*
                                var _cuber_01 = _player_rght_elbow_target[_index];
                            ...
                            try
                            {
                                ...
                                for (int x = 0; x < world_instance_x; x++)
                                {
                                    for (int y = 0; y < world_instance_y; y++)
                                    {
                                        for (int z = 0; z < world_instance_z; z++)
                                        {
                                            var indexer00 = x + world_instance_x * (y + world_instance_y * z);
                ...
                if (_has_init_screen == 0)
                {
                    ...
                    for (int i = 0; i < _screenDirMatrix_correct_pos[0].Length; i++)
                    {
                    ...
                    r = (stabilizedIntersectionPosRight - point3DCollection[0][0]).Length();
                    R = (stabilizedIntersectionPosRight - point3DCollection[0][2]).Length();
                ...
                var tempMatrix = worldMatrix_instances_screens[0][0];
                ...
                worldMatrix_instances_screen_assets[0][5] = _intersectTouchRightMatrix;
                worldMatrix_instances_screen_assets[0][6] = _intersectTouchLeftMatrix;
                worldMatrix_instances_screen_assets[0][7] = _oculusR_Cursor_matrix;
                ...
                _intersectTouchRightMatrix = _world_screen_list[0]._arrayOfInstances[0].current_pos;
                _intersectTouchRightMatrix.M41 = stabilizedIntersectionPosRight.X;
                _intersectTouchRightMatrix.M42 = stabilizedIntersectionPosRight.Y;
                _intersectTouchRightMatrix.M43 = stabilizedIntersectionPosRight.Z;
                ...
                percentXRight = D3D.SurfaceWidth - percentXRight; // gotta invert in this one... 
                ...
                _intersectTouchLeftMatrix = _world_screen_list[0]._arrayOfInstances[0].current_pos;
                _intersectTouchLeftMatrix.M41 = stabilizedIntersectionPosLeft.X;
                _intersectTouchLeftMatrix.M42 = stabilizedIntersectionPosLeft.Y;
                _intersectTouchLeftMatrix.M43 = stabilizedIntersectionPosLeft.Z;
                ...
                //HMD POINTER
                somematroxer2 = _world_screen_list[0]._arrayOfInstances[0].current_pos;
                var screenNormaler = sc_maths._getDirection(Vector3.ForwardRH, _testQuater);
                var planor = new Plane(new Vector3(_world_screen_list[0]._arrayOfInstances[0].current_pos.M41, _world_screen_list[0]._arrayOfInstances[0].current_pos.M42, _world_screen_list[0]._arrayOfInstances[0].current_pos.M43), screenNormaler);
                var centerPosOculusRift = new Vector3(_hmdPoser.X, _hmdPoser.Y, _hmdPoser.Z) + OFFSETPOS;
                Matrix oculusRifter;
                Matrix.RotationQuaternion(ref _hmdRoter, out oculusRifter);
                oculusRifter = oculusRifter * originRot * rotatingMatrix * rotatingMatrixForPelvis;
                ...
                percentXRift *= D3D.SurfaceWidth;
                percentYRift *= D3D.SurfaceHeight;
                ...
                /*var _index = 0;// x + world_instance_x * (y + world_instance_y * z);
        ...
        {
            int _index = 0;// x + world_instance_x * (y + world_instance_y * z);
        ...
        {
            int _index = x + world_instance_x * (y + world_instance_y * z);
        ...
        void _process_stuffer(RigidBody rigidbody, int x, int y, int z, int count, Matrix _matrix_to_set)
        {
            ...
            worldMatrix_instances_screens[x + world_instance_x * (y + world_instance_y * z)][count] = _matrix_to_set;// someRotationFinal;
            ...
            */
            ...
            /*worldMatrix_instances[x + world_instance_x * (y + world_instance_y * z)][count] = _grabbed_object_matrix;// someRotationFinal;
