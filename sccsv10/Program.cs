...
namespace _sc_core_systems
{
    internal class Program
    {
        ...
        public static int init_vr_main_swtch = -1;
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < _main_received_messages.Length; i++)
            {
                ...
                _main_received_messages[i]._world_data = new object[_Max_Size_00];

                for (int j = 0; j < _main_received_messages[i]._world_data.Length; j++)
                {
                    _main_received_messages[i]._world_data[j] = new object();
                }
                    ...
                    _thread_main_loop:
                        ...
                        if (_some_other_swtch == 1)
                        {
                            ...
                            if (has_init_directx == 1)
                            {
                                ...
                                {
                                    Thread _mainTasker01 = new Thread((input0) =>
                                    {
