    ...
    public abstract class SC_console_directx: ISCCS_Jitter_Interface
    {
        ...
        protected virtual void SC_Init_DirectX() //DSystemConfiguration configuration, IntPtr Hwnd, sc_console.sc_console_writer _writer
        {
            ...
            try
            {
                ...
                {
                    jitter_sc[] jitter_sc = new jitter_sc[Program._physics_engine_instance_x * Program._physics_engine_instance_y * Program._physics_engine_instance_z];
                    SC_message_object_jitter[][] _sc_jitter_tasks = new SC_message_object_jitter[Program._physics_engine_instance_x * Program._physics_engine_instance_y * Program._physics_engine_instance_z][];

                    sc_jitter_data _sc_jitter_data = new sc_jitter_data();
                    _sc_jitter_data.alloweddeactivation = Program._allow_deactivation;
                    _sc_jitter_data.allowedpenetration = Program._world_allowed_penetration;
                    _sc_jitter_data.width = Program.world_width;
                    _sc_jitter_data.height = Program.world_height;
                    _sc_jitter_data.depth = Program.world_depth;
                    _sc_jitter_data.gravity = Program._world_gravity; 
                    _sc_jitter_data.smalliterations = Program._world_small_iterations;
                    _sc_jitter_data.iterations = Program._world_iterations;
                    ...
                    for (int xx = 0; xx < Program._physics_engine_instance_x; xx++)
                    {
                        for (int yy = 0; yy < Program._physics_engine_instance_y; yy++)
                        {
                            for (int zz = 0; zz < Program._physics_engine_instance_z; zz++)
                            {
                                ...
                                _sc_jitter_tasks[indexer00] = new SC_message_object_jitter[Program.world_width * Program.world_height * Program.world_depth];
                    ...
                    _sc_jitter_tasks = init_update_variables(_sc_jitter_tasks, Program.config, Program.consoleHandle, Program.SC_GLOBALS_ACCESSORS.SC_CONSOLE_WRITER);
        ...
        protected abstract SC_message_object_jitter[][] init_update_variables(SC_message_object_jitter[][] _sc_jitter_tasks, SCCoreSystems.sc_core.sc_system_configuration configuration, IntPtr hwnd, sc_console.sc_console_writer _writer); //void Update();
