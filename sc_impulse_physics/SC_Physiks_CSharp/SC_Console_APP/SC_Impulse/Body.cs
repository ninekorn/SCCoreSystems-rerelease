...
namespace SCCoreSystems
{
    ...
    public class Body
    {
        ...
        public int isStatic;
        public float originOrient;

        public float lastOrient;
        ...
        public Body(Shape shape, int x, int y)
        {
            ...
            force.set(0, 0);
            staticFriction = 0.5f; //0.5f
            dynamicFriction = 0.3f; //0.3f
            restitution = 0.2f;
        ...
        public void setOriginOrient(float radians)
        {
            originOrient = radians;
            shape.setOriginOrient(radians);
        }

        public void setLastOrient(float radians)
        {
            lastOrient = radians;
            shape.setLastOrient(radians);
        }
    }
}
