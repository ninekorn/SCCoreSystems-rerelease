    ...
    public class ImpulseMath
{
    ...
    public static float EPSILON = 0.0001f;// Mathf.Epsilon;
    ...
    public static float PENETRATION_ALLOWANCE = 0.01f; //0.05f
    public static float PENETRATION_CORRECTION = 0.03f; //0.4f
