...
{
    public class CollisionPolygonCircle : CollisionCallback// implements CollisionCallback
{
    public static CollisionPolygonCircle instance = new CollisionPolygonCircle();
