using System;
namespace SCCoreSystems.sc_console_menu
{
    public static class sc_console_menu_01
    {
        static SCCoreSystems.sc_message_object.sc_message_object _someReceivedObject0 = new SCCoreSystems.sc_message_object.sc_message_object();
        static SCCoreSystems.sc_message_object.sc_message_object _data00_IN;
        static SCCoreSystems.sc_message_object.sc_message_object _toReturnObject;

        public static SCCoreSystems.sc_message_object.sc_message_object _console_menu(object _main_object)
        {
            try
            {
                _data00_IN = (SCCoreSystems.sc_message_object.sc_message_object)_main_object;
