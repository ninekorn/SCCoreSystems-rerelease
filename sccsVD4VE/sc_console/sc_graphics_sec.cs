    ...
    public class sc_graphics_sec //: SC_Update//SC_Intermediate_Update
    {
        ...
        public SC_message_object_jitter[][] _sc_create_world_objects(SC_message_object_jitter[][] _sc_jitter_tasks)
        {
            try
            {
                                ...
                                for (int x = 0; x < MainWindow.world_width; x++)
                                {
                                    for (int y = 0; y < MainWindow.world_height; y++)
                                    {
                                        for (int z = 0; z < MainWindow.world_depth; z++)
                                        {
                                            ...
                                            _cuber = new SC_cube();
                                            _hasinit3 = _cuber.Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight, 0.1f, 1, 1, _cube_size_x, _cube_size_y, _cube_size_z, new Vector4(r, g, b, a), _inst_cube_x, _inst_cube_y, _inst_cube_z, SC_Update.HWND, _object_worldmatrix, 6, offsetPosX, offsetPosY, offsetPosZ, _jitter_world, SCCoreSystems.sc_console.SC_console_directx.BodyTag.physicsInstancedCone, false, 1, 100, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
                                            _world_cone_list[indexer00][indexer01] = _cuber;

                                            _array_of_last_frame_cone_pos[indexer00][indexer01] = new Vector3[_inst_cube_x * _inst_cube_y * _inst_cube_z];

                                            worldMatrix_instances_cone[indexer00][indexer01] = new Matrix[_inst_cube_x * _inst_cube_y * _inst_cube_z];
                                            ...
                                            _size_screen = 0.00045f;
                                            _cuber = new SC_cube();
                                            _hasinit3 = _cuber.Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight, 0.1f, 1, 1, _cube_size_x, _cube_size_y, _cube_size_z, new Vector4(r, g, b, a), _inst_cube_x, _inst_cube_y, _inst_cube_z, SC_Update.HWND, _object_worldmatrix, 7, offsetPosX, offsetPosY, offsetPosZ, _jitter_world, SCCoreSystems.sc_console.SC_console_directx.BodyTag.physicsInstancedCylinder, false, 1, 100, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
                                            _world_cylinder_list[indexer00][indexer01] = _cuber;

                                            _array_of_last_frame_cylinder_pos[indexer00][indexer01] = new Vector3[_inst_cube_x * _inst_cube_y * _inst_cube_z];

                                            worldMatrix_instances_cylinder[indexer00][indexer01] = new Matrix[_inst_cube_x * _inst_cube_y * _inst_cube_z];
                                            ...
                                            _size_screen = 0.00045f;
                                            _cuber = new SC_cube();
                                            _hasinit3 = _cuber.Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight, 0.1f, 1, 1, _cube_size_x, _cube_size_y, _cube_size_z, new Vector4(r, g, b, a), _inst_cube_x, _inst_cube_y, _inst_cube_z, SC_Update.HWND, _object_worldmatrix, 8, offsetPosX, offsetPosY, offsetPosZ, _jitter_world, SCCoreSystems.sc_console.SC_console_directx.BodyTag.physicsInstancedCapsule, false, 1, 100, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
                                            _world_capsule_list[indexer00][indexer01] = _cuber;

                                            _array_of_last_frame_capsule_pos[indexer00][indexer01] = new Vector3[_inst_cube_x * _inst_cube_y * _inst_cube_z];

                                            worldMatrix_instances_capsule[indexer00][indexer01] = new Matrix[_inst_cube_x * _inst_cube_y * _inst_cube_z];
                                            ...
                                            _size_screen = 0.00045f;
                                            _cuber = new SC_cube();
                                            _hasinit3 = _cuber.Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight, 0.1f, 1, 1, _cube_size_x, _cube_size_y, _cube_size_z, new Vector4(r, g, b, a), _inst_cube_x, _inst_cube_y, _inst_cube_z, SC_Update.HWND, _object_worldmatrix, 1, offsetPosX, offsetPosY, offsetPosZ, _jitter_world, SCCoreSystems.sc_console.SC_console_directx.BodyTag.physicsInstancedSphere, false, 1, 100, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
                                            _world_sphere_list[indexer00][indexer01] = _cuber;

                                            _array_of_last_frame_sphere_pos[indexer00][indexer01] = new Vector3[_inst_cube_x * _inst_cube_y * _inst_cube_z];

                                            worldMatrix_instances_sphere[indexer00][indexer01] = new Matrix[_inst_cube_x * _inst_cube_y * _inst_cube_z];
                ...
                _world_containment_grid_list_RH[0][0].Initialize(SC_console_directx.D3D, 2, 2, _size_screen, 10, 10, _grid_size_x, _grid_size_y, _grid_size_z, new Vector4(r, g, b, a), _inst_terrain_tile_x, _inst_terrain_tile_y, _inst_terrain_tile_z, SC_Update.HWND, _object_worldmatrix, 1, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, SCCoreSystems.sc_console.SC_console_directx.BodyTag.sc_containment_grid, true, 0, 10, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
                ...
                _world_containment_grid_list_LH[0][0].Initialize(SC_console_directx.D3D, 2, 2, _size_screen, 10, 10, _grid_size_x, _grid_size_y, _grid_size_z, new Vector4(r, g, b, a), _inst_terrain_tile_x, _inst_terrain_tile_y, _inst_terrain_tile_z, SC_Update.HWND, _object_worldmatrix, 1, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, SCCoreSystems.sc_console.SC_console_directx.BodyTag.sc_containment_grid, true, 0, 10, 0, 0, 0); //, "terrainGrassDirt.bmp" //0.00035f
                ...
                _player_lft_lower_arm[0][0].Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight, 0, 1, 1, 1, 0.035f, 0.10550f, 0.035f,
                    new Vector4(r, g, b, a), _inst_p_r_hand_x, _inst_p_r_hand_y, _inst_p_r_hand_z, MainWindow.consoleHandle, _tempMatroxer, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world,
                ...
                _player_lft_upper_arm[0][0].Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight, 0, 1, 1, 1, 0.035f, 0.10550f, 0.035f, new Vector4(r, g, b, a),
                    _inst_p_l_hand_x, _inst_p_l_hand_y, _inst_p_l_hand_z, MainWindow.consoleHandle, _tempMatroxer, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static,
                ...
                _player_r_upper_leg[0][0].Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight, 1, 0.1f, 1, 1, 0.035f, 0.10550f, 0.035f, new Vector4(r, g, b, a),
                    _inst_p_upper_r_leg_x, _inst_p_upper_r_leg_y, _inst_p_upper_r_leg_z, MainWindow.consoleHandle, _tempMatroxer, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static,
                ...
                _player_r_lower_leg[0][0].Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight, 0, 1, 1, 1, 0.035f, 0.10550f, 0.035f, new Vector4(r, g, b, a),
                    _inst_p_lower_r_leg_x, _inst_p_lower_r_leg_y, _inst_p_lower_r_leg_z, MainWindow.consoleHandle, _tempMatroxer, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static,
                ...
                _player_r_foot[0][0].Initialize(SC_console_directx.D3D, SC_console_directx.D3D.SurfaceWidth, SC_console_directx.D3D.SurfaceHeight, 0, 1, 1, 1, 0.035f, 0.10550f, 0.035f, new Vector4(r, g, b, a),
                    _inst_p_r_foot_x, _inst_p_r_foot_y, _inst_p_r_foot_z, MainWindow.consoleHandle, _tempMatroxer, _type_of_cube, offsetPosX, offsetPosY, offsetPosZ, _thejitter_world, _mass, is_static,
                ...
                */
                ...
                if (!Terrain.Initialize(SC_console_directx.D3D.Device, "../../../heightmap01.bmp"))
                    MainWindow.MessageBox((IntPtr)0, "fail load heightmap", "sccs message", 0);
            }
            catch (Exception ex)
            {
            ...
            for (int xx = 0; xx < MainWindow._physics_engine_instance_x; xx++)
            {
                for (int yy = 0; yy < MainWindow._physics_engine_instance_y; yy++)
                {
                    for (int zz = 0; zz < MainWindow._physics_engine_instance_z; zz++)
                    {
                                                ...
                                                while (enumerator.MoveNext())
                                                {
                                                    ...
                                                    if (body != null && body.Tag != null) //&& body != _grab_rigid_data._body
                                                    {
                                                        ...
                                                        else if ((SCCoreSystems.sc_console.SC_console_directx.BodyTag)body.Tag == SCCoreSystems.sc_console.SC_console_directx.BodyTag.physicsInstancedCone)
                                                        {
                                                            ...
                                                            worldMatrix_instances_cone[indexer00][indexer01][_non_voxel_cone_counter] = translationMatrix;
                                                            _array_of_last_frame_cone_pos[indexer00][indexer01][_non_voxel_cone_counter] = new Vector3(translationMatrix.M41, translationMatrix.M42, translationMatrix.M43);
                                                        ...
                                                        else if ((SCCoreSystems.sc_console.SC_console_directx.BodyTag)body.Tag == SCCoreSystems.sc_console.SC_console_directx.BodyTag.physicsInstancedCylinder)
                                                        {
                                                            ...
                                                            worldMatrix_instances_cylinder[indexer00][indexer01][_non_voxel_cylinder_counter] = translationMatrix;
                                                            _array_of_last_frame_cylinder_pos[indexer00][indexer01][_non_voxel_cylinder_counter] = new Vector3(translationMatrix.M41, translationMatrix.M42, translationMatrix.M43);
                                                        ...
                                                        else if ((SCCoreSystems.sc_console.SC_console_directx.BodyTag)body.Tag == SCCoreSystems.sc_console.SC_console_directx.BodyTag.physicsInstancedCapsule)
                                                        {
                                                            ...
                                                            worldMatrix_instances_capsule[indexer00][indexer01][_non_voxel_capsule_counter] = translationMatrix;
                                                            _array_of_last_frame_capsule_pos[indexer00][indexer01][_non_voxel_capsule_counter] = new Vector3(translationMatrix.M41, translationMatrix.M42, translationMatrix.M43);
                                                        ...
                                                        else if ((SCCoreSystems.sc_console.SC_console_directx.BodyTag)body.Tag == SCCoreSystems.sc_console.SC_console_directx.BodyTag.physicsInstancedSphere)
                                                        {
                                                            ...
                                                            worldMatrix_instances_sphere[indexer00][indexer01][_non_voxel_sphere_counter] = translationMatrix;
                                                            _array_of_last_frame_sphere_pos[indexer00][indexer01][_non_voxel_sphere_counter] = new Vector3(translationMatrix.M41, translationMatrix.M42, translationMatrix.M43);
                        ...
                        {
                            Console.WriteLine("PHYSICS SECTION" + ex.ToString());
                        }
                    }
                }
            }
        ...
        public SC_message_object_jitter[][] workOnSomething(SC_message_object_jitter[][] _sc_jitter_tasks, Matrix viewMatrix, Matrix projectionMatrix, Vector3 OFFSETPOS, Matrix originRot, Matrix rotatingMatrix, Matrix hmdrotMatrix, Matrix hmd_matrix, Matrix rotatingMatrixForPelvis, Matrix _rightTouchMatrix, Matrix _leftTouchMatrix, Posef handPoseRight, Posef handPoseLeft, SC_SharpDX_ScreenFrame screenFrame)
        {
            ...
            SC_Update._shaderManager.RenderInstancedGrid(SC_console_directx.D3D.device.ImmediateContext, _world_grid_list[0][0].IndexCount, _world_grid_list[0][0].InstanceCount, _world_grid_list[0][0]._POSITION, viewMatrix, projectionMatrix, null, _DLightBuffer_grid, _world_grid_list[0][0]); // oculusRiftDir
            ...
            */
            ...
            if (display_grid_type == 1 || display_grid_type == 2 || display_grid_type == 3)
            {
                ...
                SC_Update._shaderManager.RenderInstancedContainmentGrid(SC_console_directx.D3D.device.ImmediateContext, _world_containment_grid_list_RH[0][0].IndexCount, _world_containment_grid_list_RH[0][0].InstanceCount, _world_containment_grid_list_RH[0][0]._POSITION, viewMatrix, projectionMatrix, null, _DLightBuffer_containment_grid, _world_containment_grid_list_RH[0][0]); // oculusRiftDir

                //PHYSICS GRID
                _world_containment_grid_list_LH[0][0].Render(SC_console_directx.D3D.device.ImmediateContext);
                SC_Update._shaderManager.RenderInstancedContainmentGrid(SC_console_directx.D3D.device.ImmediateContext, _world_containment_grid_list_LH[0][0].IndexCount, _world_containment_grid_list_LH[0][0].InstanceCount, _world_containment_grid_list_LH[0][0]._POSITION, viewMatrix, projectionMatrix, null, _DLightBuffer_containment_grid, _world_containment_grid_list_LH[0][0]); // oculusRiftDir
            ...
            SC_Update._shaderManager.RenderInstancedObject(SC_console_directx.D3D.device.ImmediateContext, sc_jitter_cloth._cube.IndexCount, sc_jitter_cloth._cube.InstanceCount, sc_jitter_cloth._cube._POSITION, viewMatrix, projectionMatrix, null, _DLightBuffer_cube, sc_jitter_cloth._cube); // oculusRiftDir
            */

            //PHYSICS SCREENS
            _world_screen_list[0][0].Render(SC_console_directx.D3D.device.ImmediateContext);
            SC_Update._shaderManager.RenderInstancedObject(SC_console_directx.D3D.device.ImmediateContext, _world_screen_list[0][0].IndexCount, _world_screen_list[0][0].InstanceCount, _world_screen_list[0][0]._POSITION, viewMatrix, projectionMatrix, screenFrame._ShaderResource, _DLightBuffer_cube, _world_screen_list[0][0]);
            //END OF 
